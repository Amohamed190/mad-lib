...
// let result2 = `"There are too many ${pluralNoun} on this ${adjective} airplane!", I screamed. "Somebody has to ${verb} on the ${noun} to solve this problem."`
